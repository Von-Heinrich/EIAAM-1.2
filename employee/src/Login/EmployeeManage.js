...
const Manage = () => {
    ...
    // const { valueToSend } = location.state || {};
    const [updateTime,setUpdateTime] = useState();
    const { valueToManage } = location.state || {};
    ...
    return (
        <div>
            ...
            <div className='Manage_Row'><span>{valueToManage.userRole}:{valueToManage.username}<span></span></span></div><br /><br />
