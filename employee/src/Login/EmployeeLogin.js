...
const EmployeeLogin = () => {
    ...
    const valueToSend = { name: '斉藤', admin: "管理者" };
                    ...
                    if (response.status === 200) {
                        ...
                        if (response.data === null || response.data === '') {
                          ...
                          sessionStorage.setItem('user', JSON.stringify(user));*/
                            ...
                            const valueToMaster = { userID: userID, username: userName, password: pwd, userRole: userRole, pwd2: pwd2 }

                            navigate('/Master', { state: { valueToMaster } });
                        }
                    } else {
                        // 登录失败
